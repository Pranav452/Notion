...
export default function DashboardPage() {
  ...
  const getActivityData = () => {
    ...
    const thisWeek = workspaces.filter(w => 
      new Date(w.updated_at) > new Date(today.getTime() - 7 * 24 * 60 * 60 * 1000)
    ).length;
    const thisMonth = workspaces.filter(w => 
      new Date(w.updated_at) > new Date(today.getTime() - 30 * 24 * 60 * 60 * 1000)
    ).length;
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      ...
                      {((thisWeek / workspaces.length) * 100).toFixed(0)}% of total
                    </p>
                  </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentWorkspaces.map((workspace, index) => (
                  <div key={workspace.id} className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors cursor-pointer"
                ...
                {recentWorkspaces.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-slate-400">Create your first workspace to get started</p>
                  </div>
                )}
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-purple-200 rounded-full flex items-center justify-center">
                  <span className="text-xs font-medium text-purple-700">AS</span>
                </div>
                <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-900">Mike Brown</p>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className={viewMode === 'grid' ? 'bg-slate-900 text-white' : ''}
                >
                ...
                <Button
                  ...
                  className={viewMode === 'list' ? 'bg-slate-900 text-white' : ''}
                >
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-slate-500">{workspace.description || 'No description'}</p>
                        </div>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <Card className="w-full max-w-md mx-4 bg-white shadow-2xl border-slate-200">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl text-slate-900">Create New Workspace</CardTitle>
                <p className="text-sm text-slate-600">Set up a new knowledge base for your team</p>
              </CardHeader>
              <CardContent>
